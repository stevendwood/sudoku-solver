...
export default class Solver {
    ...
    _search() {
        ...
        if (!this.grid.isSolved()) {
            ...
            throw new Error(`Tried all values for this cell  [${cell.row}, ${cell.col}] ${cell.possibleValues}`);
        }
    }
        ...
        this.grid
            ...
            .forEach((p) => {
                ...
                if (p.possibleValues.length === 0) {
                    throw new Error(`No possible values for cell [${p.row}, ${p.col}] ${p.value}`);
                }
            });
    }
